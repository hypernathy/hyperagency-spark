      ...
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#0F1014] rounded-lg p-8 sm:p-12 lg:p-16 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 relative z-10">
            ...
            {/* Right - price box */}
            <div className="bg-muted border border-primary/20 rounded-sm p-8">
              ...
              <button className="w-full bg-primary text-primary-foreground font-mono text-sm py-3 rounded-sm hover:bg-primary/90 transition-colors">
                {t.power.cta}
              </button>
            </div>
          </div>
