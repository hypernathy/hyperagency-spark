    ...
    <section id="services" className="py-24 sm:py-32 bg-card">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          ...
          <p className="font-mono text-base text-muted-foreground mb-12 max-w-2xl">{t.services.sub}</p>
        </ScrollReveal>
          ...
          {services.map((s) => (
            <StaggerItem key={s.num} variant="scale-up">
              ...
              >
                ...
                <p className="font-mono text-sm text-muted-foreground leading-relaxed mb-6 flex-1">{s.desc}</p>
