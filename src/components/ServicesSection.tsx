    ...
    <section id="services" className="py-24 sm:py-32 bg-card">
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {services.map((s) => (
            <div key={s.num} className="bg-background border border-foreground/[0.07] rounded-sm p-8 flex flex-col hover:border-b-2 hover:border-b-primary transition-all group">
